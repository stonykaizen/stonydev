    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-12 lg:flex-row lg:gap-8">
        ...
        <div className="flex flex-col text-center lg:text-left lg:w-1/2 z-10">
          <div className="hero-badge mx-auto lg:mx-0 mb-6 flex max-w-fit items-center gap-2.5 rounded-full glass px-4 py-1.5 text-xs font-semibold backdrop-blur-md">
            ...
            <span className="text-[10px] uppercase tracking-widest font-semibold text-blue-400">
              Estudio de Desarrollo Web · Uruguay
            </span>
          </div>
          ...
          <h1 className="mb-6 overflow-hidden text-5xl font-extrabold tracking-tighter text-white sm:text-6xl md:text-7xl leading-[0.9]">
            ...
            <span className="hero-title-line block text-gradient">con Impacto Visual.</span>
          </h1>

          <p className="hero-desc mb-8 max-w-xl text-base text-slate-400 sm:text-lg leading-relaxed">
            Somos <span className="font-bold text-white">stonydev.com</span>, un estudio de cuatro
            socios que cubre todo el ciclo: <span className="font-bold text-purple-400">UX/UI</span>
            , <span className="font-bold text-amber-400">datos</span>,{' '}
            <span className="font-bold text-emerald-400">backend</span> y{' '}
            <span className="font-bold text-blue-400">fullstack con automatizaciones</span>.
          </p>
        ...
        >
          ...
          <div
            ref={(el) => {
              if (el) floatingCards.current[0] = el;
            }}
          ...
          >
            ...
            <div className="font-mono text-[10px] text-slate-400 leading-relaxed bg-black/30 p-3 rounded-lg border border-white/5">
              <span className="text-purple-400">gsap</span>.to(
              <span className="text-blue-300">".hero-title"</span>, &#123;
              <br />
              ...
              &nbsp;&nbsp;stagger: <span className="text-orange-300">0.2</span>
              <br />
              &#125;);
            </div>
          ...
          <div
            ref={(el) => {
              if (el) floatingCards.current[1] = el;
            }}
          ...
          <div
            ref={(el) => {
              if (el) floatingCards.current[2] = el;
            }}
