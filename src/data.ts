import { Project, ProjectCategory, ProjectGoal, Service, TechItem, CalculatorStep } from './types';

// Etiquetas visibles por categoría técnica (chips del modal y tarjetas).
export const CATEGORY_LABELS: Record<ProjectCategory, string> = {
  frontend: 'Website',
  fullstack: 'Software SaaS',
  ecommerce: 'Comercio Electrónico',
  design: 'Interactivo / UI',
};

// Filtros por objetivo de negocio — el lenguaje del cliente, no el nuestro.
export const GOAL_FILTERS: { id: ProjectGoal | 'all'; label: string }[] = [
  { id: 'all', label: 'Todos' },
  { id: 'reservas', label: 'Reservas & Turnos' },
  { id: 'catalogo', label: 'Catálogo & Pedidos' },
  { id: 'leads', label: 'Clientes & SEO Local' },
];
...
export const SERVICES: Service[] = [
  {
    ...
    description:
      'Diseño y desarrollo web corporativo ultra veloz, optimizado para posicionamiento en Google (SEO) y diseñado para convertir visitas en clientes reales.',
    features: [
  ...
  },
  {
    ...
    description:
      'Tiendas online robustas y seguras con experiencias de compra intuitivas, pasarelas de pago integradas y paneles de administración autogestionables.',
    features: [
  ...
  },
  {
    ...
    description:
      'Soluciones de software personalizadas en la nube para automatizar procesos de negocio, gestionar datos complejos o lanzar tu propio producto digital.',
    features: [
  ...
  },
  {
    ...
    description:
      'Transformo sitios web lentos y desactualizados en plataformas modernas de alto rendimiento, aplicando las mejores prácticas de desarrollo.',
    features: [
...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      'Sitio para clínica odontológica orientado a tratamientos de ticket alto (implantes, ortodoncia) captados por SEO local, sin pauta.',
    category: 'frontend',
    goal: 'leads',
    tags: ['SEO Local', 'WhatsApp', 'React', 'Ticket Alto'],
    image: '/projects/dental.webp',
    details:
      'Por qué este nicho: un solo implante o tratamiento de ortodoncia captado por Google paga el sitio completo. La demanda ya existe ("dentista cerca de mí") — no hay que crearla con publicidad, solo capturarla con SEO local y convertirla con reserva inmediata por WhatsApp.',
    features: [
  ...
  },
  {
    ...
    description:
      'Motor de reservas propio para complejo turístico: cada reserva directa ahorra el 15-25% que se llevan Booking y Airbnb.',
    category: 'fullstack',
    goal: 'reservas',
    tags: ['Booking Engine', 'Node.js', 'MercadoPago', 'Cero Comisión'],
    image: '/projects/cabanas.webp',
    details:
      'Por qué este nicho: los complejos ya pagan hasta un cuarto de su facturación en comisiones de portales. Un motor de reservas propio se amortiza en pocas reservas y el huésped que ya conoce el lugar reserva directo — retorno inmediato sin gastar un peso en publicidad.',
    features: [
  ...
  },
  {
    ...
    description:
      'Agenda self-service con recordatorios automáticos: menos huecos, menos ausencias y clientes que vuelven todos los meses.',
    category: 'design',
    goal: 'reservas',
    tags: ['Agenda Online', 'PWA', 'Recurrencia', 'Recordatorios'],
    image: '/projects/barberia.webp',
    details:
      'Por qué este nicho: el cliente de barbería vuelve cada 3-4 semanas — el valor está en la recurrencia, no en captar tráfico nuevo. Con agenda online y recordatorios automáticos se reducen las ausencias y se llenan los huecos, todo con la clientela que ya existe: inversión publicitaria cero.',
    features: [
  ...
  },
  {
    ...
    description:
      'Catálogo online para clientes de obra que repiten pedido todas las semanas: ticket alto y recurrente, sin un peso de pauta.',
    category: 'ecommerce',
    goal: 'catalogo',
    tags: ['B2B', 'Catálogo', 'WhatsApp', 'Pedidos Recurrentes'],
    image: '/projects/corralon.webp',
    details:
      'Por qué este nicho: el corralón ya tiene la clientela — constructores que piden todas las semanas por teléfono. Digitalizar el pedido (catálogo + carrito que se envía por WhatsApp) baja la fricción, aumenta el ticket promedio y fideliza al cliente de obra sin necesidad de captar tráfico pago.',
    features: [
  ...
  },
  {
    ...
    description:
      'Sitio institucional para estudio jurídico: una sola consulta captada por Google puede pagar el sitio varias veces.',
    category: 'frontend',
    goal: 'leads',
    tags: ['SEO Local', 'Leads', 'Autoridad', 'Ticket Alto'],
    image: '/projects/juridico.webp',
    details:
      'Por qué este nicho: los servicios jurídicos tienen el lead más caro del mercado publicitario — pero quien busca "abogado laboral" en Google ya necesita uno ahora. Un sitio con autoridad, casos de éxito y consulta directa captura esa demanda orgánica sin competir en subastas de anuncios.',
    features: [
  ...
  },
  {
    ...
    description:
      'Plataforma con historial de mascotas y recordatorios de vacunas: cada aviso automático es una consulta que vuelve sola.',
    category: 'fullstack',
    goal: 'reservas',
    tags: ['Recordatorios', 'CRM', 'Recurrencia', 'WhatsApp'],
    image: '/projects/veterinaria.webp',
    details:
      'Por qué este nicho: cada mascota necesita vacunas y controles todos los años, pero la mayoría de los dueños simplemente se olvida. Un recordatorio automático por WhatsApp en la fecha justa trae la visita sin ningún costo de captación — ingresos recurrentes activados por software, no por publicidad.',
    features: [
...
export const CALCULATOR_STEPS: CalculatorStep[] = [
  {
    ...
    options: [
      {
        id: 'landing',
        label: 'Landing Page / One-Page',
        description:
          'Ideal para promocionar un producto, evento o servicio específico de forma directa.',
        cost: 600,
        icon: 'Layout',
      },
      {
        ...
        description: 'Web institucional multi-página para dar a conocer tu empresa y captar leads.',
        cost: 1200,
        icon: 'Globe',
      },
      {
        ...
        description: 'Plataforma para vender productos físicos o digitales con carrito de compras.',
        cost: 2200,
        icon: 'ShoppingBag',
      },
      {
        id: 'saas',
        label: 'Aplicación Web / SaaS',
        description: 'Desarrollo de software a medida, bases de datos e integraciones complejas.',
        cost: 3500,
        icon: 'Cpu',
      },
    ],
  },
  {
    ...
    options: [
      {
        id: 'clean',
        label: 'Limpio y Funcional',
        description:
          'Basado en layouts probados de conversión, tipografía cuidada y pocos elementos visuales complejos.',
        cost: 0,
        icon: 'FileText',
      },
      {
        id: 'premium',
        label: 'Premium e Interactivo',
        description:
          'Identidad visual personalizada, animaciones interactivas GSAP, y diseño de componentes únicos.',
        cost: 400,
        icon: 'Sparkles',
      },
      {
        id: 'immersive',
        label: 'Experiencia Inmersiva de Lujo',
        description:
          'Micro-interacciones avanzadas, efectos 3D sutiles, transiciones líquidas y narrativa interactiva completa.',
        cost: 1000,
        icon: 'Flame',
      },
    ],
    ...
    options: [
      {
        ...
        description: 'Registro con Google, email, perfiles y panel de cliente privado.',
        cost: 300,
        icon: 'Users',
      },
      {
        id: 'pagos',
        label: 'Pasarela de Pagos Avanzada',
        description: 'Suscripciones mensuales, pagos recurrentes e internacionalización monetaria.',
        cost: 450,
        icon: 'CreditCard',
      },
      {
        id: 'multi',
        label: 'Multi-idioma Automatizado',
        description:
          'Soporte completo para traducción de contenidos dinámicos (Español/Inglés/Portugués).',
        cost: 250,
        icon: 'Languages',
      },
      {
        ...
        description: 'Chatbots inteligentes, autogeneración de informes o resúmenes automatizados.',
        cost: 500,
        icon: 'Bot',
      },
    ],
